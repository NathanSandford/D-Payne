...
pos, prob, state = sampler.run_mcmc(p0,100000)

# Plot MCMC Results
for i in range(ndim):
    plt.plot(sampler.chain[:,:,i].T, '-', alpha=0.1)
    plt.savefig('chains_dim%i_100000.png' %i)

chain = sampler.chain[:, :, 0].T
fig = corner.corner(chain)
plt.savefig('cornerplot_100000.png')
...
plt.savefig('Auto_Correlation_100000.png')
